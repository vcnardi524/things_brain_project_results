...
<div style="display: flex; gap: 16px; margin-bottom: 16px;">
  ...
  <img src="images/GTI2.png" alt="GTI2" width="45%">
</div>

<div style="display: flex; gap: 16px; margin-bottom: 16px;">
  <img src="images/RI3.png" alt="RI3" width="45%">
  <img src="images/GTI3.png" alt="GTI3" width="45%">
</div>

<div style="display: flex; gap: 16px; margin-bottom: 16px;">
  <img src="images/RI4.png" alt="RI4" width="45%">
  <img src="images/GTI4.png" alt="GTI4" width="45%">
</div>
